...
You can use the `ggsave()` function to write your plot to a file. `ggsave()` will automatically determine the file type based on the extension on the file name. It will also set the size and resolution of the image by default.
